...
def test_get(redis_handler: RedisHandler) -> None:
    ...
    redis_handler.redis_client.get.return_value = b"value"  # type: ignore[union-attr]
...
def test_set(redis_handler: RedisHandler) -> None:
    ...
    redis_handler.redis_client.set.assert_called_with("key", "value", ex=None)  # type: ignore[union-attr]
...
def test_get_redis_error(redis_handler: RedisHandler) -> None:
    ...
    with patch(
        ...
        redis_handler.redis_client.get.side_effect = Exception("Redis connection error")  # type: ignore[union-attr]
...
def test_set_redis_error(redis_handler: RedisHandler) -> None:
    ...
    with patch(
        ...
        redis_handler.redis_client.set.side_effect = Exception("Redis connection error")  # type: ignore[union-attr]
...
def test_set_with_expiry(redis_handler: RedisHandler) -> None:
    ...
    redis_handler.redis_client.set.assert_called_with("key", "value", ex=3600)  # type: ignore[union-attr]
