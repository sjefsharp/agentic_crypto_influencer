...
from error_management.error_manager import ErrorManager, main
...
def test_handle_error(error_manager: ErrorManager) -> None:
    ...
    with patch("error_management.error_manager.logging.error") as mock_logging_error:
...
def test_main_function() -> None:
    ...
    with (
        patch("error_management.error_manager.logging.error") as mock_logging_error,
