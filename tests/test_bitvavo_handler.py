...
from tools.bitvavo_handler import BitvavoHandler, main
...
def bitvavo_handler() -> BitvavoHandler:
    ...
    handler.client = MagicMock()  # type: ignore
    return handler
...
def test_main_success() -> None:
    ...
    with (
        patch("tools.bitvavo_handler.BitvavoHandler") as mock_handler_class,
