...
X_TOKEN_URL_FALLBACK = "https://api.x.com/2/oauth2/token"
...
ERROR_TOKEN_REFRESH_FAILED = "Failed to refresh access token"
...
TOKEN_KEY_TOKEN_TYPE = "token_type"
TOKEN_KEY_EXPIRES_AT = "expires_at"
